...
QtObject {
    ...
    readonly property string spotify: "<font face='JetBrainsMono Nerd Font Mono'>󰓇</font>"
    readonly property string firefox: "<font face='JetBrainsMono Nerd Font Mono'>󰈹</font>"
    readonly property string chromium: "<font face='JetBrainsMono Nerd Font Mono'></font>"
    readonly property string telegram: "<font face='JetBrainsMono Nerd Font Mono'></font>"
    readonly property string discord: "<font face='JetBrainsMono Nerd Font Mono'></font>"
    ...
    // Horizontal battery set (used for the "bar" indicator style)
    readonly property string batteryHCharging: "\uE0BA"
    readonly property string batteryHFull: "\uE0C0"
    readonly property string batteryHHigh: "\uE0C2"
    readonly property string batteryHMedium: "\uE0C6"
    readonly property string batteryHLow: "\uE0C4"
    readonly property string batteryHEmpty: "\uE0BE"
