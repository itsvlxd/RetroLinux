...
Rectangle {
    ...
    // Adaptive sizing so the calendar can scale to any widget size.
    property real cellSize: 28
    property real fontPixel: Styling.fontSize(-2)
    ...
    StyledRect {
        ...
        Text {
            ...
            font.pixelSize: button.fontPixel
