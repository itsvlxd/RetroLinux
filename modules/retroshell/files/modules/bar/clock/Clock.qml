...
Item {
    ...
    Timer {
        ...
        onTriggered: {
            var now = new Date();
            cardTime = [now.getHours(), now.getMinutes(), now.getSeconds()].map(function(x) { return x.toString().padStart(2, '0'); }).join(":");
            cardDate = Qt.formatDateTime(now, "ddd, MMM d");
        }
    }
    ...
    StyledRect {
        ...
        RowLayout {
            ...
            Text {
                id: tempDisplay
                text: root.weatherAvailable && Config.bar.showWeatherTemp ? Math.round(WeatherService.currentTemp) + "°" + Config.weather.unit : ""
            ...
            Text {
                id: dayOfWeekDisplay
                text: Config.bar.showDayOfWeek ? root.currentDayAbbrev : ""
                visible: text.length > 0
                color: root.popupOpen ? buttonBg.item : Colors.overBackground
    ...
    BarPopup {
        ...
        Column {
            ...
            StyledRect {
                ...
                enableShadow: false
                width: 300 + 16
                height: clockSection.implicitHeight + 8 + calendarContent.implicitHeight + 28
                ...
                Timer {
                    ...
                    repeat: true
                    onTriggered: clockCalendarCard.currentDate = new Date()
                }
                    ...
                    Column {
                        ...
                        Item {
                            ...
                            Text {
                                ...
                                text: calendarContent.capitalizeMonth(clockCalendarCard.currentDate)
                        ...
                        Row {
                            ...
                            Column {
                                ...
                                property date dayDate: {
                                    var d = new Date(clockCalendarCard.weekStart);
                                    d.setDate(d.getDate() + index);
                                    return d;
                                }
                                property bool isToday: index === clockCalendarCard.currentDayOfWeek
