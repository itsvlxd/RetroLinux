    ...
    def get_gpu_stats(self):
        ...
        for gpu in self.gpu_info:
            ...
            if gpu["vendor"] == "nvidia":
                ...
                if card:
                    try:
                        with open(f"/sys/class/drm/{card}/gt_cur_freq_mhz", "r") as f:
                            cur = int(f.read().strip())
                        with open(f"/sys/class/drm/{card}/gt_max_freq_mhz", "r") as f:
                    ...
                    try:
                        ...
                        if os.path.exists(hwmon_base):
                            ...
                            if dirs:
                                with open(os.path.join(hwmon_base, dirs[0], "temp1_input"), "r") as f:
                                    t = int(f.read().strip()) // 1000
                    except:
                        pass
            usages.append(u)
