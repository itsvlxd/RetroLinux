...
//@ pragma ShellId retroshell
//@ pragma DataDir $BASE/retroshell
//@ pragma StateDir $BASE/retroshell
...
ShellRoot {
    ...
    Loader {
        id: countdownLoader
        active: GlobalStates.countdownOverlayVisible
        source: "modules/tools/CountdownOverlay.qml"
    }
