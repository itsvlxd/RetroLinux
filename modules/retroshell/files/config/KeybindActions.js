...
var ACTION_CATALOG = [
    { id: "retroshell.launcher", label: "Open Launcher", category: "RetroShell", dispatcher: "exec", argument: "retro shell run launcher", flags: "r" },
    { id: "retroshell.dashboard", label: "Open Dashboard", category: "RetroShell", dispatcher: "exec", argument: "retro shell run dashboard" },
    { id: "retroshell.assistant", label: "Open Assistant", category: "RetroShell", dispatcher: "exec", argument: "retro shell run assistant" },
    { id: "retroshell.clipboard", label: "Open Clipboard", category: "RetroShell", dispatcher: "exec", argument: "retro shell run clipboard" },
    { id: "retroshell.emoji", label: "Open Emoji", category: "RetroShell", dispatcher: "exec", argument: "retro shell run emoji" },
    { id: "retroshell.notes", label: "Open Notes", category: "RetroShell", dispatcher: "exec", argument: "retro shell run notes" },
    { id: "retroshell.tmux", label: "Open Tmux", category: "RetroShell", dispatcher: "exec", argument: "retro shell run tmux" },
    { id: "retroshell.wallpapers", label: "Open Wallpapers", category: "RetroShell", dispatcher: "exec", argument: "retro shell run wallpapers" },
    { id: "retroshell.config", label: "Open Settings", category: "RetroShell", dispatcher: "exec", argument: "retro shell run config" },
    { id: "retroshell.overview", label: "Open Overview", category: "RetroShell", dispatcher: "exec", argument: "retro shell run overview" },
    { id: "retroshell.powermenu", label: "Open Power Menu", category: "RetroShell", dispatcher: "exec", argument: "retro shell run powermenu" },
    { id: "retroshell.tools", label: "Open Tools", category: "RetroShell", dispatcher: "exec", argument: "retro shell run tools" },
    { id: "retroshell.screenshot", label: "Take Screenshot", category: "RetroShell", dispatcher: "exec", argument: "retro shell run screenshot" },
    { id: "retroshell.screenrecord", label: "Screen Record", category: "RetroShell", dispatcher: "exec", argument: "retro shell run screenrecord" },
    { id: "retroshell.lens", label: "Open Lens", category: "RetroShell", dispatcher: "exec", argument: "retro shell run lens" },
    { id: "retroshell.reload", label: "Reload Retro Shell", category: "RetroShell", dispatcher: "exec", argument: "retroshell reload" },
    { id: "retroshell.quit", label: "Quit Retro Shell", category: "RetroShell", dispatcher: "exec", argument: "retroshell quit" },
    ...
    { id: "system.dpms-on", label: "Display On", category: "System", dispatcher: "exec", argument: 'hyprctl dispatch hl.dsp.dpms({ action: "enable" })', flags: "l" },
...
function actionFromLegacy(dispatcher, argument, flags) {
    ...
    if (dispatcher === "exec") {
        ...
        if (arg.indexOf("hyprctl dispatch hl.dsp.dpms") === 0 && arg.indexOf("enable") !== -1) return { id: "system.dpms-on", args: {} };
