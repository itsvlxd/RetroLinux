                ...
                if primary_sink ~= "" then
                    ...
                    if primary_id ~= "" then
                        if cur_sink ~= primary_id then
                            Watcher.log("audio", "Enforcing primary sink: " .. primary_sink .. " (ID " .. primary_id .. "), current was " .. cur_sink, "info")
                ...
                if primary_source ~= "" then
                    ...
                    if primary_id ~= "" then
                        if cur_source ~= primary_id then
                            Watcher.log("audio", "Enforcing primary source: " .. primary_source .. " (ID " .. primary_id .. "), current was " .. cur_source, "info")
