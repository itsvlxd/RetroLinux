...
PAGE_REGISTRY: list[tuple[str, str, str, str]] = [
    ...
    ("shell_dashboard", "Dashboard", "Dashboard launcher widgets and quick actions", DASHBOARD_ICON),
    ...
    ("fan_control", "Fan Control", "Fan speeds, curves and cooling profiles", FAN_CONTROL_ICON),
