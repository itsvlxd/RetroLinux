...
COMMENTS = (
    ...
    "gathers everything Retro Linux touches into a single, searchable window: "
    "appearance, shell, input, display, windows, startup, system, and advanced "
    "options. Tweak, preview, and undo freely; nothing is saved until you review "
